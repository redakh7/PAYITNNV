                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                            ...
                            Text('STEP 1 : Identification ', style: GoogleFonts.manrope(
                              fontWeight: FontWeight.bold,
                              fontSize: 18,

                            ),),
                          SizedBox(height: 5,),
                          Text('Saisissez votre numéro de Tél et votre CIN  ', style: GoogleFonts.manrope(
                            fontWeight: FontWeight.w400,
                            fontSize: 16,
                          ...
                          Container(
                            child: Text('En continuant, vous acceptez les terms et conditions de l\'utlisation', style: GoogleFonts.manrope(
                              fontWeight: FontWeight.w400,
                              fontSize: 14,
                            ),),
                          ),
