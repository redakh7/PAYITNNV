...
class _FormulairePaymentState extends State<FormulairePayment> {
  ...
  point_of_initiation_methode? _character = point_of_initiation_methode.dynamique;
              ...
              child: Container(
                ...
                Column(
                  ...
                  SizedBox(height: 20,),
                    ...
                    Text('financial institution code',style: TextStyle(fontSize: 18, color: Colors.blueGrey,)),
                    SizedBox(
                      height: 8,
                    ),
                    TextFormField(
                      ...
                      validator: (value)  {
                        if (value!.isEmpty) {
                          return " the financial_institution_code must not be empty";
                        }},
                      decoration: InputDecoration(
                        contentPadding: const EdgeInsets.symmetric(),
                        border: OutlineInputBorder(
                    ...
                    SizedBox(height: 25,),
                    Text('merchant category code',style: TextStyle(fontSize: 18, color: Colors.blueGrey,)),
                    SizedBox(
                      height: 8,
                    ),
                    TextFormField(
                    ...
                    SizedBox(height: 20,),
                    Text('country code',style: TextStyle(fontSize: 18, color: Colors.blueGrey,)),
                    SizedBox(
                      height: 8,
                    ),
                    Container(
                    ...
                    SizedBox(height: 25,),
                    Text('merchant name',style: TextStyle(fontSize: 18, color: Colors.blueGrey,)),
                    SizedBox(
                      height: 8,
                    ),
                    TextFormField(
                    ...
                    Text('merchant city',style: TextStyle(fontSize: 18, color: Colors.blueGrey,)),
                    SizedBox(
                      height: 8,
                    ),
                    TextFormField(
